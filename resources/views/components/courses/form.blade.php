<form method="POST" id="form-course" wire:submit.prevent="save">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div class="col-span-1 sm:col-span-2">
            <x-toggle md label="Active" wire:model.defer="active" id="course-active" />
        </div>
        ...
        <x-files.select label="Certificate" placeholder="Select a certificate" mimetype="application/pdf" wire:model.defer="file_certificate_id" />
